function onPageLoad() {
	function changeLanguage(selectedLanguage) {
		...
		if (selectedLanguage === "en") {
			...
			heroTitle.textContent = "雷霆引擎：释放你的游戏开发创造力";
			heroParagraph.textContent = "欢迎来到雷霆引擎的世界，这里是您无限游戏开发可能性的门户！";
			
			aboutTitle.textContent = "什么是雷霆引擎？";
			aboutParagraph.textContent = "雷霆引擎是游戏开发世界的一次革命。它是一个免费开源、多功能轻量级的游戏引擎，可让创作者轻松创建令人惊叹的2D和3D游戏。我们的使命是简化游戏开发，让您可以专注于做您最擅长的事情 - 创造引人入胜的游戏！";
			
			descTitle.textContent = "为什么选择雷霆引擎？";
			ossTitle.textContent = "免费开源游戏引擎";
			ossParagraph.textContent = "告别许可费用和限制！雷霆引擎完全免费，无论您是业余爱好者、独立开发者还是游戏工作室的一部分，您都可以充分利用雷霆引擎的全部功能，而不必花费一分钱。";
			
			modTitle.textContent = "模块化架构";
			modParagraph.textContent = "雷霆引擎提供了灵活的模块化架构，适应您项目的独特需求。通过选择适合您创意愿景的组件来定制您的游戏开发工作流程。有了雷霆引擎，您完全掌握了局面！";
			
			docTitle.textContent = "全面的文档";
			docParagraph.textContent = "我们明白每位开发者的学习之路都是从学习开始的。这就是为什么雷霆引擎提供全面且用户友好的文档。无论您是老手还是新手，我们的资源都会在每一步引导您。";
			
			gitTitle.textContent = "GitHub集成";
			gitParagraph.textContent = "合作是雷霆引擎的核心。我们的GitHub集成允许您与充满活力的开发者社区联系，分享您的项目并访问丰富的开源资源。一起，我们可以将游戏开发推向新的高度！";
			
			readyTitle.textContent = "准备好开始了吗？";
			readyParagraph1.textContent = "不要错过改变游戏开发之旅的机会。立即加入雷霆引擎社区，解锁您创造力的全部潜力！";
			readyParagraph2.textContent = "立即下载，并开始使用雷霆引擎踏上您的游戏开发之旅。";
		}
	}
